 ...
 * @author Rasmus
 */
@WebService(serviceName = "webService", portName = "port", endpointInterface = "eu.x_road.emta_v6.WebServiceInterface", targetNamespace = "http://emta-v6.x-road.eu", wsdlLocation = "WEB-INF/wsdl/xTeeFieService/services (1).wsdl")
public class xTeeFieService {
